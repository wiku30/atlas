...
public:
  ...
  void onInit() override {
    ...
    points_sub = mt_nh.subscribe("/rslidar_points", 5, &HdlLocalizationNodelet::points_callback, this);
    globalmap_sub = nh.subscribe("/globalmap", 1, &HdlLocalizationNodelet::globalmap_callback, this);
    initialpose_sub = nh.subscribe("/initialpose", 8, &HdlLocalizationNodelet::initialpose_callback, this);

    //gps_sub = nh.subscribe("/vehicle/gps/fix", 1024, &HdlLocalizationNodelet::gps_callback, this);
	gps_sub = nh.subscribe("/ublox_gps_node/fix", 1024, &HdlLocalizationNodelet::gps_callback, this);
    vel_sub = nh.subscribe("/ublox_gps_node/fix_velocity", 1024, &HdlLocalizationNodelet::vel_callback, this);
...
private:
...
#if (use_gps)
		auto aligned = pose_estimator->correct(filtered, now_gps, map_utm, now_vel);
#else
  ...
  void vel_callback(const geometry_msgs::TwistWithCovarianceStampedConstPtr& vel_msg){
	  now_vel = v3(vel_msg->twist.twist.linear.x, vel_msg->twist.twist.linear.y, vel_msg->twist.twist.linear.z);
	  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	  //CRITICAL: The sensor data in this car has x and y reversed.
	  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  }
